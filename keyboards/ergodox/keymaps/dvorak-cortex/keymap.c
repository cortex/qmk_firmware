...
[BASE] = KEYMAP(  // layer 0 : default
        ...
        KC_ESC,         KC_QUOT,        KC_COMM, KC_DOT, KC_P,   KC_Y,   TG(1),
        KC_TAB,         KC_A,           KC_O,    KC_E,   KC_U,   KC_I,
        KC_LSFT,        CTL_T(KC_SCLN), KC_Q,    KC_J,   KC_K,   KC_X,   KC_LGUI,
        ...
        // right hand
             ...
             KC_RGUI,     KC_B,   KC_M,   KC_W,   KC_V,   CTL_T(KC_Z),      KC_RSFT,
